...
1. Raw thoughts land in `BACKLOG.md` (the user's inbox/capture file).
...
| `BACKLOG.md` | Raw capture point (“inbox”). Brain dumps, meeting notes, ideas, links. No organization required. | User |
